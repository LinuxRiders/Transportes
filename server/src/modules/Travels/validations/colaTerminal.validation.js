...
export const createColaValidation = [
    body('id_terminal').isInt({ min: 1 }).withMessage('id_terminal debe ser un entero positivo'),
    body('id_vehiculo').isInt({ min: 1 }).withMessage('id_vehiculo debe ser un entero positivo'),
    body('hora_llegada').isISO8601().withMessage('hora_llegada debe ser una fecha válida'),
