...
export const User = {
  ...
  update: async (id, fields, connection = pool) => {
    try {
      ...
      await connection.execute(
        `UPDATE USER SET ${setClause}, updated_at = NOW() WHERE user_id = ?`,
        values
      );
    } catch (error) {
  ...
  softDelete: async (id, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:User:softDelete Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  getAll: async (connection = pool) => {
    try {
      const [rows] = await connection.execute(
        "SELECT user_id, username, email, status, created_at, updated_at FROM USER WHERE deleted_at IS NULL"
      );
      return rows;
    } catch (error) {
...
export const Role = {
  create: async ({ name, description }, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:Role:create Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  findById: async (id, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:Role:findById Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  findByName: async (name, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:Role:findByName Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  update: async (id, fields, connection = pool) => {
    try {
      ...
      values.push(id);
      await connection.execute(
        `UPDATE ROLE SET ${setClause}, updated_at = NOW() WHERE role_id = ?`,
        values
      );
    } catch (error) {
  ...
  softDelete: async (id, connection = pool) => {
    try {
      await connection.execute(
        "UPDATE ROLE SET deleted_at = NOW() WHERE role_id = ?",
        [id]
      );
    } catch (error) {
      logger.error(`[Model]:Role:softDelete Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  getAll: async (connection = pool) => {
    try {
      ...
      logger.error(`[Model]:Role:getAll Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
...
export const UserRole = {
  assignRole: async (user_id, role_id, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:UserRole:assignRole Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  removeRole: async (user_id, role_id, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:UserRole:removeRole Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  getRolesByUser: async (user_id, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:UserRole:getRolesByUser Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
...
export const Persona = {
  ...
  create: async (
    ...
    try {
      ...
      logger.error(
        `[Model]:Persona:create Error inserting persona: ${error.message}`,
        { stack: error.stack }
      );
      throw error;
    }
  ...
  findById: async (id, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:Persona:findById Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  update: async (id, fields, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:Persona:update Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  softDelete: async (id, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:Persona:softDelete Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  getAll: async (connection = pool) => {
    try {
      ...
      logger.error(`[Model]:Persona:getAll Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
...
export const GuiaTuristico = {
  create: async (
    ...
    try {
      ...
      logger.error(`[Model]:GuiaTuristico:create Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  findById: async (id, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:GuiaTuristico:findById Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  update: async (id, fields, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:GuiaTuristico:update Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  softDelete: async (id, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:GuiaTuristico:softDelete Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  getAll: async (connection = pool) => {
    try {
      ...
      logger.error(`[Model]:GuiaTuristico:getAll Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
...
export const Pasajero = {
  create: async (
    ...
    try {
      const query = `
                ...
                VALUES (?,?,?)
            `;
      const values = [foto_pasajero, idPersona, created_by];
      const [result] = await connection.execute(query, values);
      return result.insertId; // Realmente es el idPasajero
    } catch (error) {
      logger.error(`[Model]:Pasajero:create Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  findById: async (id, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:Pasajero:findById Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  update: async (id, fields, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:Pasajero:update Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  softDelete: async (id, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:Pasajero:softDelete Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  getAll: async (connection = pool) => {
    try {
      ...
      logger.error(`[Model]:Pasajero:getAll Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
...
export const Conductor = {
  create: async (
    { idPersona, foto_conductor, celular_contacto, created_by = null },
    connection = pool
  ) => {
    try {
      const query = `
                ...
                VALUES (?,?,?,?)
            `;
      const values = [foto_conductor, celular_contacto, idPersona, created_by];
      const [result] = await connection.execute(query, values);
      return result.insertId; // Realmente es idConductor
    } catch (error) {
      logger.error(`[Model]:Conductor:create Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  findById: async (id, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:Conductor:findById Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  update: async (id, fields, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:Conductor:update Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
  ...
  softDelete: async (id, connection = pool) => {
    try {
      ...
      logger.error(`[Model]:Conductor:softDelete Error: ${error.message}`, {
        stack: error.stack,
      });
      throw error;
    }
